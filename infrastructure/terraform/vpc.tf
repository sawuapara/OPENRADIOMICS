# OpenRadiomics - VPC and Networking Configuration

# VPC for OpenRadiomics
...
# Public Subnets (in different AZs for RDS subnet group requirement)
...
resource "aws_security_group" "rds" {
  ...
  # PostgreSQL access from allowed IP
  ingress {
